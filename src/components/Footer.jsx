...
export default function Footer(){
  return(
    <footer className="pbr-footer text-white">
      <div className="row g-4 pb-4">
        <div className="col-lg-4">
          <p className="fw-semibold fs-6 mb-3">Connect with us</p>
          ...
          <h6 className="fw-bold fs-5 mb-3">About PBCCR</h6>
          <p className="text-white-50" style={{lineHeight:1.8}}>PBCCR has evolved over time by stabilizing its case-finding practices to generate reliable cancer incidence statistics.</p>
          <Link to="/about" className="pbr-footer-link fw-semibold">Learn More →</Link>
        </div>
        <div className="col-lg-4">
        ...
        <div className="col-lg-4">
          <h6 className="fw-bold fs-5 mb-3">Data Visualization</h6>
      ...
      <div className="pbr-footer-bottom d-flex justify-content-between align-items-center flex-wrap gap-2">
        <span className="small opacity-80">© PBCCR 2026 — All Rights Reserved</span>
        <div className="d-flex gap-4"><a href="#" className="text-white small">Terms of use</a><a href="#" className="text-white small">Privacy Policy</a></div>
      </div>
    </footer>
  )
}